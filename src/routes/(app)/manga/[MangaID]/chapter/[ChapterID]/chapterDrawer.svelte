...
{#if mangaMeta}
	<div class="flex flex-col p-4">
		...
		<div class="flex flex-col space-y-2 my-2">
			<Slide class="outline-0 p-1 hover:variant-glass-surface" bind:checked={$mangaMeta.Margins}>
				Page Margins
			</Slide>
			<Slide class="outline-0 p-1 hover:variant-glass-surface" bind:checked={$mangaMeta.Scale}>
				Page Scale
			</Slide>
			<Slide
			...
			{#if $mangaMeta.ReaderMode !== Mode.Vertical}
				<Slide class="outline-0 p-1 hover:variant-glass-surface" bind:checked={$mangaMeta.Offset}>
					Page Offset
				</Slide>
			{/if}
			<label class="pl-3">
			...
			<Slide class="outline-0 p-1 hover:variant-glass-surface" bind:checked={$ViewNav}>
