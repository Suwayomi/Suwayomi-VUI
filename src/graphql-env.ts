...
const introspection = {
  "__schema": {
    ...
    "types": [
      ...
      {
        "kind": "INPUT_OBJECT",
        "name": "ContentWarningFilterInput",
        "inputFields": [
          {
            "name": "distinctFrom",
            "type": {
      ...
      {
        "kind": "INPUT_OBJECT",
        "name": "ExtensionStoreConditionInput",
        "inputFields": [
          {
            "name": "id",
            "type": {
      ...
      {
        "kind": "INPUT_OBJECT",
        "name": "ExtensionStoreFilterInput",
        "inputFields": [
          {
            "name": "and",
            "type": {
